...
export const commandsToCreate: Array<CommandConfig> = [
    ...
    { id: "duplicate-line-right", name: "Selection Right", direction: Direction.Right, condition: "selectionRight" },
    { id: "duplicate-line-left", name: "Selection Left", direction: Direction.Left, condition: "selectionLeft" },
